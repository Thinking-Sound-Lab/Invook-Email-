...
function MailRow({
  ...
  return (
    <Link
      ...
      scroll={false}
      className={cn(
        "group relative grid min-h-10 grid-cols-[minmax(112px,0.3fr)_minmax(0,1fr)_6.5rem] items-center gap-3 border-b border-border/40 px-4 py-1.5 transition-colors [contain-intrinsic-size:40px] [content-visibility:auto] lg:grid-cols-[minmax(112px,0.3fr)_minmax(0,1fr)_6.5rem_1rem_7rem] lg:gap-2.5",
