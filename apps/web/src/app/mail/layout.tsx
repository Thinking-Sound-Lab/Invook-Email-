  ...
  return (
    <MailShellProvider shell={shell}>
      <main className="flex h-dvh flex-col overflow-hidden bg-background">
        ...
        <div className="grid min-h-0 flex-1 grid-rows-[minmax(0,1fr)] grid-cols-[64px_minmax(0,1fr)] lg:grid-cols-[240px_minmax(0,1fr)] xl:grid-cols-[240px_minmax(520px,1fr)_360px]">
