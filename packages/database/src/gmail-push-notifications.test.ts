...
test(
  ...
  async () => {
    ...
    try {
      ...
      // A capped range leaves the pending cursor set; the incremental
      // synchronization entity reads it and schedules another pass, so no
      // durable continuation step is created.
